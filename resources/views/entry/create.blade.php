        ...
        <div>
            <form action="{{ route('entries.store') }}" method="POST" class="w-full" enctype="multipart/form-data">
                ...
                <label class="form-control w-full">
                    ...
                    <input type="text" name="title" placeholder="Entry Title" autofocus
                ...
                <label class="form-control">
                    ...
                    <textarea rows=5 class="w-full rounded-sm mb-4 mt-2 textarea textarea-bordered h-48" placeholder="Description"
