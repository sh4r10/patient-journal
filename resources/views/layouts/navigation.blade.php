<nav x-data="{ open: false }" class="bg-blue-950">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        ...
                        rounded-md text-blue-950 bg-blue-100 hover:text-slate-700 focus:outline-none transition ease-in-out duration-150">
