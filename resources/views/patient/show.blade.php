...
@endsection
    ...
    <div class="w-full">
        ...
        <div class="mt-12 max-w-screen-md m-auto">
            ...
            <div class="my-10">
                <div class="md:hidden block flex flex-col justify-center items-center gap-4 w-full bg-white p-6 mb-6 rounded shadow-sm hover:shadow-md transition ease-in-out delay-50">
                    ...
                    <div class="dropdown dropdown-bottom dropdown-end dropdown-hover w-full">
                        <div tabindex="0" role="button" class="btn btn-wide btn-neutral w-full">Manage Patient</div>
                        <ul tabindex="0" class="dropdown-content z-[1] menu p-2 shadow bg-base-100 rounded-box w-52">
                            <li>
                                <a href={{route('patients.edit', $patient)}}>Update</a>
                            </li>
